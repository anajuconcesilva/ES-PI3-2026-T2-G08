            ...
            Expanded(
              child: FutureBuilder<BalcaoData>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (!snapshot.hasData ||
                      snapshot.data!.startups.isEmpty) {

                    return const Center(
                      child: Text(
                        "Nenhuma startup disponível no momento.",
                      ),
                    );
                  }

                  var startups =
                      snapshot.data!.startups;
                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder:
                        ...
                        final stats =
                        _calculateOfferStats(
                          startupId,
                          offers,
                        );

                        final volumeFormatado =
                        stats['volume']!
                            .toStringAsFixed(2)
                            .replaceAll(
                          '.',
