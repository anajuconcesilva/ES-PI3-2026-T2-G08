            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const _Action(icon: Icons.attach_money, label: "Comprar"),
                    const _Action(icon: Icons.credit_card, label: "Vender"),
                    _Action(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    const _Nav(icon: Icons.home, label: "Início", active: true),
                    _Nav(
